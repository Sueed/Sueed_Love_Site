    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.TextField(default='Sueed，网络，IT，技术，博客，Python，web', help_text='用来作为SEO中keywords，长度参考SEO标准', max_length=240, verbose_name='关键字')),
            ],
            options={
                'verbose_name': '大分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='Sueedの小窝，记录生活瞬息，分享学习心得', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
                ('bigcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sueed.bigcategory', verbose_name='大分类')),
            ],
            options={
                'verbose_name': '分类',
